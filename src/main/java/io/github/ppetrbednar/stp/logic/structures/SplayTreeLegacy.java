...
public class SplayTreeLegacy<K extends Comparable<K>, V> implements ISplayTree<K, V> {
    ...
    public SplayTreeLegacy() {
    }

    public SplayTreeLegacy(Node root) {
        this.root = root;
    }
    ...
    public V remove(K key) {
        ...
        SplayTreeLegacy<K, V> left = new SplayTreeLegacy<>(root.left);
        SplayTreeLegacy<K, V> right = new SplayTreeLegacy<>(root.right);
    ...
    private SplayTreeLegacy<K, V> union(SplayTreeLegacy<K, V> left, SplayTreeLegacy<K, V> right) {
